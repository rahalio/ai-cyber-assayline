/**
 * Tiering Services - Application Layer Export
 *
...
/**
 * Tiering Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for tiering domain.
 */
